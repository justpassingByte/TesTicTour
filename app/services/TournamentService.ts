...
export class TournamentService {
  static async list(): Promise<{ tournaments: ITournament[] }> {
    try {
  ...
  static async detail(id: string): Promise<ITournament> {
    try {
  ...
  static async update(id: string, data: Partial<ITournament>): Promise<ITournament> {
    try {
  ...
  static async listParticipants(tournamentId: string, page: number = 1, limit: number = 10): Promise<{ participants: IParticipant[] }> {
    try {
