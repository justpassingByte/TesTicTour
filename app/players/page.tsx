  ...
  return (
    <div className="container py-10 space-y-8">
      <div className="flex flex-col space-y-2 md:flex-row md:items-center md:justify-between md:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground">
            Discover top TFT players, view their statistics, and track their tournament performance.
          </p>
        </div>
      ...
      <section className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold mb-2">Featured Players</h2>
          <p className="text-muted-foreground">Top performing players in recent tournaments</p>
        </div>
            ...
            >
              <CardContent className="pt-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    <span className="text-sm text-muted-foreground">Top 4 Rate:</span>
      ...
      <section className="space-y-6">
        <div>
          <h2 className="text-2xl font-bold mb-2">Player Directory</h2>
          <p className="text-muted-foreground">Browse and search through all registered players</p>
        </div>
          ...
          <div className="flex gap-2">
            ...
            <Select value={sortBy} onValueChange={setSortBy}>
              ...
              <SelectContent>
                ...
                <SelectItem value="averagePlacement">Avg. Placement</SelectItem>
    ...
    <Card className="card-hover-effect">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div>
            <div className="text-muted-foreground">Top 4 Rate</div>
            <div className="font-medium">{player.topFourRate}%</div>
          </div>
        </div>

        <div className="space-y-2">
          <div className="text-sm font-medium">Recent Tournaments</div>
