    ...
    <div className="space-y-4">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-auto font-medium">{formatCurrency(tournament.entryFee * (tournament.actualParticipantsCount || 0)*(1-(tournament.hostFeePercent || 0)))}</span>
            </div>
          </div>
      ...
      <Card className="border shadow-sm">
        ...
        <CardContent className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
          {prizeRanks.map(rank => {
            const totalPrizePool = tournament.entryFee * (tournament.actualParticipantsCount || 0) * (1 - (tournament.hostFeePercent || 0));
